...
export default function ProjectTerritoryJourneyV3() {
  ...
  const updateLayerState = (nextStage: StageId) => {
    ...
    // Em Brasil e Nordeste o ponto reforça a referência quando a geometria fica pequena.
    basinPointLayerRef.current?.setVisible(isBrazil || isNortheast);
        ...
        <div className={styles.journeyNote}>
          ...
          <span>
            {stage === "bacia"
              ...
              : stage === "rn"
                ? "O contorno estadual enquadra a geometria real da Bacia do Rio Potengi."
                : stage === "nordeste"
